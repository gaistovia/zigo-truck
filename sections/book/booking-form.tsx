...
export function BookingForm() {
  ...
  if (submitted) {
    return (
      <motion.div
        ...
        className="flex flex-col items-center rounded-xl3 border border-ink-600/[0.06] bg-white p-10 text-center shadow-premium-lg dark:border-white/[0.06] dark:bg-ink-700 md:p-16"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
  ...
  return (
    <motion.form
      ...
      noValidate
      className="rounded-xl3 border border-ink-600/[0.06] bg-white p-6 shadow-premium-lg dark:border-white/[0.06] dark:bg-ink-700 md:p-10"
    >
