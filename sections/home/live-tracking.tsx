    ...
    <section className="bg-surface py-28 dark:bg-ink md:py-36">
      <Container>
        ...
        <motion.div
          ...
          className="mt-16 grid overflow-hidden rounded-xl3 border border-line bg-white shadow-premium-lg dark:bg-ink-700 dark:border-white/[0.06] lg:grid-cols-[1.4fr_1fr]"
        >
          {/* Map panel */}
          ...
          <div className="flex flex-col justify-between p-8 md:p-10">
            <div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="rounded-2xl border border-line p-4 dark:border-white/[0.06]">
                  <div className="flex items-center gap-2 text-ink-600 dark:text-white/50">
                    <Clock3 size={14} />
                    <span className="text-xs">ETA</span>
                  </div>
                  <p className="mt-1 font-numeric text-lg font-semibold text-ink dark:text-white">
                    1h 24min
                  </p>
                </div>
                <div className="rounded-2xl border border-line p-4 dark:border-white/[0.06]">
