        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          {TESTIMONIALS.map((t, i) => (
            <motion.div
              ...
              className="relative flex flex-col rounded-xl2 border border-line bg-surface p-8 transition-all duration-500 ease-premium hover:-translate-y-1 hover:shadow-premium dark:bg-ink-700 dark:border-white/[0.06]"
            >
              ...
              <div className="mt-7 flex items-center gap-3 border-t border-line pt-5 dark:border-white/[0.06]">
