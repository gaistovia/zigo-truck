        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {INDUSTRIES.map((industry, i) => (
            <motion.div
              ...
              className="group flex items-start gap-5 rounded-xl2 border border-line p-7 transition-all duration-500 ease-premium hover:-translate-y-1 hover:border-brand/20 hover:shadow-premium dark:border-white/[0.06]"
            >
