    ...
    <section className="relative overflow-hidden bg-surface py-28 dark:bg-ink md:py-36">
      <Container>
        ...
        <motion.div
          ...
          className="mt-16 overflow-hidden rounded-xl3 border border-ink-600/[0.06] bg-white shadow-premium-lg dark:bg-ink-700 dark:border-white/[0.08]"
        >
          {/* Fake window chrome */}
          <div className="flex items-center gap-2 border-b border-ink-600/[0.06] px-6 py-4 dark:border-white/[0.06]">
          ...
          <div className="grid gap-px bg-ink-600/[0.06] p-px dark:bg-white/[0.06] md:grid-cols-4">
            {METRICS.map((metric, i) => (
              ...
              >
                ...
                <p className="mt-4 font-display text-2xl font-semibold text-ink dark:text-white">
                  {metric.value}
                </p>
